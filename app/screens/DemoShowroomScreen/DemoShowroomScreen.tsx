...
const WebListItem: FC<DemoListItem> = ({ item, sectionIndex }) => {
  ...
  return (
    <View>
      <Link screen="Home" params={{ queryIndex: sectionSlug }} style={themed($menuContainer)}>
...
export const DemoShowroomScreen: FC<TabScreenProps<"Home">> = function DemoShowroomScreen(_props) {
