...
const hi: Translations = {
  ...
  welcomeScreen: {
    tagline: "हर रसीद, व्यवस्थित।",
    subtitle: "आपकी रसीदें। क्रमबद्ध। खोजने योग्य। सुरक्षित।",
    featureScan: "रसीदें तुरंत कैप्चर और सेव करें",
    featureOrganize: "अपने खर्चों को स्वचालित रूप से वर्गीकृत करें",
    featureInsights: "एक नज़र में खर्चों पर नज़र रखें",
