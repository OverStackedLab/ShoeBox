...
const en = {
  ...
  forgotPasswordScreen: {
    ...
    enterDetails: "Enter the email associated with your account and we'll send you a reset link.",
    emailFieldLabel: "Email",
    emailFieldPlaceholder: "Enter your email address",
  ...
  updatePasswordScreen: {
    ...
    enterDetails: "Choose a new password for your account.",
    passwordFieldLabel: "New Password",
    passwordFieldPlaceholder: "Create a new password",
    confirmPasswordFieldLabel: "Confirm Password",
    confirmPasswordFieldPlaceholder: "Repeat your new password",
